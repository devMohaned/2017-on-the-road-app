...
public class FindPassengersMaps extends AppCompatActivity implements OnMapReadyCallback {
        ...
        mShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Shareable shareAction = new Shareable.Builder(FindPassengersMaps.this)
                    ...
                    Toast.makeText(FindPassengersMaps.this, "Location isn't found, please wait", Toast.LENGTH_LONG).show();
                }
            }
        });
...
*/
       /* messageItemList.add(new MessageItem("1PQqOKSkoOZyxJoWypQZhRv2e8H3","4FzaMQaPDPN8TpxJ0vWIr9vhw7g1"));
        messageItemList.add(new MessageItem("52bGbDH7HfTq7NPB52KKqAojd2g1","9aT9cQPfG9QeGSQZx0pPRMxwZYc2"));
*/
        ...
        mMessagesImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindPassengersMaps.this, MessageListActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                Toast.makeText(FindPassengersMaps.this, getString(R.string.double_click_to_chat), Toast.LENGTH_LONG).show();
                if (doubleBackToExitPressedOnce) {

                    if (tempuser != null) {

                        if (userID.equals(myCurrentUserID)) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(FindPassengersMaps.this)
...
//        addRandomMarkers();
    ...
    private void setupPreviousChats() {
        ...
        mMessagingRecyclerView.setLayoutManager(new LinearLayoutManager(this));
...
*/
            ...
            Toast.makeText(FindPassengersMaps.this, "There's something wrong with logging in, please reload the page", Toast.LENGTH_LONG).show();
        }
    }
                    ...
                    if (location != null) {
                            ...
                            if (mapShownForFirstTime) {
                                try {
                                    ...
                                    Toast.makeText(FindPassengersMaps.this, "No GPS found, you are not visible on map", Toast.LENGTH_LONG).show();
                                } }
                                ...
                                mPositionMarker =
                                        mMap.addMarker(new MarkerOptions()
                                                ...
                                                .icon(BitmapDescriptorFactory.
                                                        fromResource(R.drawable./*ic_airplanemode_active*/baseline_directions_car_black_24))
                                                .anchor(0.5f, 0.5f)
                                                .position(latLng));
                            ...
                            DatabaseReference mDriversAvailableDatabaseReference = FirebaseDatabase.getInstance()
                                    .getReference(Constants.DATABASE_GEO_FIRE_DRIVERS_AVAILABLE);
...
//        getSupportFragmentManager().beginTransaction().show(mapFragment).commit();
    ...
    private void getDriversAround() {
        ...
        DatabaseReference driverLocation = FirebaseDatabase.getInstance()
                .getReference().child(Constants.DATABASE_GEO_FIRE_PASSENGERS_AVAILABLE);
                                ...
                                Marker mDriverMarker = mMap
                                        .addMarker
                                                (new MarkerOptions()
                                                        ...
                                                        .icon(BitmapDescriptorFactory.
                                                                fromResource(R.drawable./*ic_person*/baseline_person_pin_circle_black_24)));
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getValue() != null) {
                                    for (final DataSnapshot ds : dataSnapshot.getChildren()) {
                                        if (ds.getKey() != null) {
                                            FirebaseDatabase.getInstance().getReference()
                                                    .child(Constants.DATABASE_GEO_FIRE_PASSENGERS_AVAILABLE).child(ds.getKey())
                                                    .addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if (i == dataSnapshot.getChildrenCount()) {
                                                mapFragment.getMapAsync(FindPassengersMaps.this);
                                                getSupportFragmentManager().beginTransaction().hide(mapFragment).commit();
                                                mFusedLocationClient = LocationServices.getFusedLocationProviderClient(FindPassengersMaps.this);
                                                setupViews();
                                            }
                                        }
                                    }
