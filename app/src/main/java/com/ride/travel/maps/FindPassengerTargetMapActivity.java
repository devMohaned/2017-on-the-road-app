...
public class FindPassengerTargetMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            if (everythingIsDone) {
                Intent intent = new Intent(FindPassengerTargetMapActivity.this, FindPassengersMaps.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        placeAutoComplete.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(final Place place) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(FindPassengerTargetMapActivity.this)
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mLastLocation != null) {
                                    ...
                                    if (place.getLatLng() != null) {
                                        ...
                                        FindPassengerTargetMapActivity.FetchUrl FetchUrl = new FindPassengerTargetMapActivity.FetchUrl();
                                        ...
                                        Toast.makeText(FindPassengerTargetMapActivity.this, getString(R.string.no_place_found), Toast.LENGTH_SHORT).show();
                                    }
                                } else {
//                                    Toast.makeText(FindPassengerTargetMapActivity.this, getString(R.string.error_no_location_found), Toast.LENGTH_SHORT).show();
                                    mMap.clear();
